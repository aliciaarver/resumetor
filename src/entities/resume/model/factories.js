const DEMO_RESUMES = {
    ru: {
        ...
        workExperience: [
            ...
            },
            {
                ...
                toMonth: '',
                isCurrent: false,
                description: 'Разрабатываю образы для сценических выступлений, королевских мероприятий и публичных кампаний. Известна сильным чувством цвета, умением быстро собирать визуальную концепцию и превращать стилизацию в часть бренда персонажа, события или команды.',
    ...
    en: {
        ...
        aboutMe: 'Crown Princess of Solaria, Fairy of the Shining Sun and Moon, and a founding member of the Winx Club. I combine royal diplomacy, light-based magic, and a strong fashion instinct to lead public initiatives, protect my world, and turn bold concepts into memorable experiences. My strongest work happens where visibility, team morale, and fast creative decision-making matter most.',
        workExperience: [
            {
                ...
                toMonth: '',
                isCurrent: true,
                description: 'Represent Solaria in interplanetary diplomacy, protect the realm during magical crises, and lead highly visible royal and cultural initiatives. Use sun, moon, and star magic for shielding, illumination, teleportation, and team support, while serving as one of the most public-facing figures of the kingdom.',
            ...
            },
            {
                ...
                toMonth: '',
                isCurrent: false,
                description: 'Since the club’s formation, I have been one of its core combat and support fairies, responsible for light shields, blinding attacks, teleportation, and fast coordination under pressure. I often act as the team’s morale driver and as a bridge between magical institutions, royals, and the Winx.',
            ...
            },
            {
                ...
                toMonth: '',
                isCurrent: false,
                description: 'Design looks for performances, royal events, and public appearances. Known for a sharp eye for color, styling, and visual identity, with a natural ability to turn wardrobe choices into memorable personal and event branding.',
                skills: ['Creative direction', 'Visual branding', 'Fashion design'],
            },
        ],
        education: [
...
export function createDemoResume(locale = detectPreferredLocale()) {
